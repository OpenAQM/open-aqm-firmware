...
class OaqmTimeProvider : public OaqmDevice {
  public:
    ...
    static const std::list<OaqmTimeProvider*>* getAllTimeDevices() {
        return &allDevices;
    };
  protected:
    OaqmTimeProvider() : OaqmDevice() {
  ...
  private:
    static std::list<OaqmTimeProvider*> allDevices;
};