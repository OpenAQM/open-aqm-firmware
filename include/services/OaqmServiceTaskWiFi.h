...
#ifndef OAQM_SERVICE_TASKWIFI_H
#define OAQM_SERVICE_TASKWIFI_H
...
class OaqmServiceTaskWiFi : public OaqmServiceTask {
  public:
    OaqmServiceTaskWiFi() {};
...
#if OAQM_DEVICE_ESP32_WIFI_LOWPWR == 1
